...
public class FragmentUpdatesUni extends Fragment {
    RecyclerView recyclerView;
    AdapterRecViewUpdates adapterRecViewUpdates;

    public FragmentUpdatesUni() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_updates_uni, container, false);


        if (savedInstanceState == null) {
            recyclerView = view.findViewById(R.id.recycler_view_updates_uni);
            ...
            FirebaseRecyclerOptions<ModelClassRec> options =
                    new FirebaseRecyclerOptions.Builder<ModelClassRec>()
                            .setQuery(FirebaseDatabase
                                            .getInstance().getReference("universityUpdate")
