...
public class FragmentTabWednesday extends Fragment {
    private AdapterRecViewTimetable adapterRecViewTimetable;

    public FragmentTabWednesday() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tab_wednesday, container, false);

        RecyclerView recyclerView = view.findViewById(R.id.rec_wednesday);
