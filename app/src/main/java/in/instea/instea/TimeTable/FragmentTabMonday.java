...
public class FragmentTabMonday extends Fragment {
    private AdapterRecViewTimetable adapterRecViewTimetable;

    public FragmentTabMonday() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tab_monday, container, false);

        RecyclerView recyclerView = view.findViewById(R.id.rec_monday);
