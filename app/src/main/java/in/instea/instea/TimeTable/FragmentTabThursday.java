...
public class FragmentTabThursday extends Fragment {
    private AdapterRecViewTimetable adapterRecViewTimetable;

    public FragmentTabThursday() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tab_thursday, container, false);

        RecyclerView recyclerView = view.findViewById(R.id.rec_thursday);
