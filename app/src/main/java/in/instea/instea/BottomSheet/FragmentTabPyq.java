...
public class FragmentTabPyq extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        RecyclerView pyqRecyclerView = view.findViewById(R.id.recycler_view_pyq);
        pyqRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

        // Disable RecyclerView item animator
        pyqRecyclerView.setItemAnimator(null);
...
//        Toast.makeText(getContext(), subjName, Toast.LENGTH_SHORT).show();
        ...
        pyqRecyclerView.setAdapter(tabRecViewAdapter);
